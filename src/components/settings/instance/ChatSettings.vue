    ...
    <div class="settings-tab-content">
        ...
        <el-card class="settings-card">
            ...
            <div class="setting-item">
                ...
                <div class="setting-control slider-control">
                    <el-slider v-model="localConfig.normal_chat.model_normal_probability" :min="0" :max="1" :step="0.01"
        ...
        <el-card class="settings-card">
            ...
            <div class="setting-item">
                ...
                <div class="setting-control slider-control">
                    <el-slider v-model="localConfig.focus_chat.reply_trigger_threshold" :min="1" :max="10" :step="0.1"
                        show-input />
                </div>
            </div>
            <div class="setting-item">
            ...
            <div class="setting-item">
                ...
                <div class="setting-control">
                    <el-input-number v-model="localConfig.focus_chat.consecutive_no_reply_threshold" :min="1" :max="10"
                        :step="1" />
        ...
        <el-card class="settings-card">
            ...
            <div class="setting-item">
                ...
                <div class="setting-control">
                    <el-input-number v-model="localConfig.response_splitter.response_max_length" :min="64" :max="1024"
                        :step="32" />
        ...
        <el-card class="settings-card">
            ...
            <div class="setting-item">
                ...
                <div class="setting-control slider-control">
                    <el-slider v-model="localConfig.chinese_typo.word_replace_rate" :min="0" :max="0.05" :step="0.001"
                        :format-tooltip="value => (value * 100).toFixed(1) + '%'" show-input />
                </div>
            </div>
        </el-card>
    </div>
