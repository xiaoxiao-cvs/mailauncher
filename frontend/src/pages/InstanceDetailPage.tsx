    ...
    <div className="h-full flex flex-col p-6 gap-6 overflow-hidden">
      ...
      <div className="flex-1 grid grid-cols-12 gap-6 min-h-0">
        ...
        <div className="col-span-8 flex flex-col gap-4 min-h-0 animate-slide-up opacity-0">
          {/* Terminal Window */}
          <div className="flex-1 bg-[#000000] rounded-3xl shadow-lg border border-gray-800/50 overflow-hidden flex flex-col">
            {/* Terminal Header / Tabs */}
            <div className="flex items-center px-4 py-3 bg-[#0a0a0a] border-b border-gray-800">
